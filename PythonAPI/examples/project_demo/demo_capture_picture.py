...
def sensor_callback(sensor_data, sensor_queue, sensor_name):
    if 'lidar' in sensor_name:
        sensor_data.save_to_disk(os.path.join('D:\\opt\\carla\\PythonAPI\\examples\\outout', '%06d.ply' % sensor_data.frame))
    if 'camera' in sensor_name:
        sensor_data.save_to_disk(os.path.join('D:\\opt\\carla\\PythonAPI\\examples\\outout', '%06d.png' % sensor_data.frame))
...
def main():
    ...
    try:
        ...
        output_path = 'D:\\opt\\carla\\PythonAPI\\examples\\outout'
